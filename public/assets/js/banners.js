...
///////////////////////////////////Show gallery///////////////////////////////////////////
    $(".show-images-btn").click(function(e) {
        ...
        if (type == 'featured') {
            ...
            $('#image_type').val('banner');
            $('#slider_type').val(slider_type);
            $('#slider_id').val(id);
        }
        ('input[name="checkimg[]"]').prop('checked', false);
    ...
    $('.attach_image').click(function (e) {
        ...
        if(slider_type == 'mobile-product_cat'){
            $('#mobProdCat_imageId-'+id).val(imageDetail_Id);
            $('#mobProdCatpath-'+id).val(base_url+'/'+path);
            $('#mobProdCatimg-'+id).attr('src', l.protocol + "//" + l.host+'/'+path);
        }
        else if(slider_type == 'mobile-pages'){
            $('#mobPage_imageId-'+id).val(imageDetail_Id);
            $('#mobPagepath-'+id).val(base_url+'/'+path);
            $('#mobPageimg-'+id).attr('src', l.protocol + "//" + l.host+'/'+path);
        }
        if(slider_type == 'desktop-product_cat'){
            $('#desProdCat_imageId-'+id).val(imageDetail_Id);
            $('#desProdCatpath-'+id).val(base_url+'/'+path);
            $('#desProdCatimg-'+id).attr('src', l.protocol + "//" + l.host+'/'+path);
        }
        else if(slider_type == 'desktop-pages'){
            $('#desPage_imageId-'+id).val(imageDetail_Id);
            $('#desPagepath-'+id).val(base_url+'/'+path);
            $('#desPageimg-'+id).attr('src', l.protocol + "//" + l.host+'/'+path);
        }
