        ...
        <!-- Begin: life time stats -->
            <div class="portlet ">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-Products"></i>Edit Action
                    </div>
                </div>
...
">
                                    ...
                                    <input type="hidden" name="action_id" id="action_id" value="{{ $pricing->id }}">
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Title</label>
                                            <div class="col-md-8">
                                                <input value="{{ $pricing->title }}" class="form-control input-inline input-sm " name="action_title" id="action_title"  value=""  >
                                            ...
                                            <div class="col-md-8">
                                                <div class="mt-radio-inline">
                                                    <label class="mt-radio">
                                                        <input type="radio" name="eligible_customers_type" @if($pricing->min_past_orders == 0) checked="checked" @endif class="eligible_customers_type" value="all" checked="checked"> All
                                                        <span></span>
                                                    </label>
                                                    <label class="mt-radio">
                                                        <input type="radio" name="eligible_customers_type" @if($pricing->min_past_orders != 0) checked="checked" @endif class="eligible_customers_type"  value="specific" > Specific
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group min_past_orders_div"  @if($pricing->min_past_orders != 0) style="display:block" @endif>
                                            <label class="col-md-4 control-label">Customer Min Past Orders</label>
                                            <div class="col-md-8">
                                                <input class="form-control input-inline input-sm " name="min_past_orders" id="min_past_orders" value="{{ $pricing->min_past_orders }}"  >
                                                ...
                                                <div class="row" style="padding-left:15px;">
                                                    <div class="col-sm-3 sm-select">
                                                        <select name="p_from_day" id="p_from_day" class="">
                                                            <?php
                                                                $pricing_from_year = date('Y', strtotime($pricing->date_from));
                                                                $pricing_from_month = date('m', strtotime($pricing->date_from));
                                                                $pricing_from_day = date('d', strtotime($pricing->date_from));

                                                                $days = cal_days_in_month(CAL_GREGORIAN,  $pricing_from_month, $pricing_from_year);
                                                                $options = '';
                                                                $today = date('d');

                                                                for ($i = 1; $i <=  $days; $i++)
                                                                {
                                                                    if($pricing_from_day == $i)
                                                    ...
                                                    <div class="col-sm-3 sm-year">
                                                        <select name="p_from_year" id="p_from_year" class="" onchange="getYearMonths(this.value, 'p_from_month' )">
                                                            ...
                                                            $from_y    = date('Y', strtotime($date_from));
                                                            for($y = 2016; $y <= 2060; $y++)
                                                                {
                                                                    if($from_y == sprintf("%'.02d", $y))
                                                                        $selected = 'selected="selected"';
                                                                    else
                                                                        $selected = '';
                                                    ...
                                                    <div class="col-sm-3 sm-select">
                                                        <select name="p_from_hour" id="p_from_hour" class="">
                                                            <?php
                                                                $date_from  = $pricing->date_from;
                                                                $from_hr    = date('H', strtotime($date_from));
                                                            for($ph = 0; $ph < 24; $ph++)
                                                            {
                                                                if($from_hr == sprintf("%'.02d", $ph))
                                                                    $selected = 'selected="selected"';
                                                                else
                                                                    $selected = '';
                                                                echo '<option '.$selected.' value="'.sprintf("%'.02d", $ph).'">'.sprintf("%'.02d", $ph).'</option>';
                                                            }
                                                    ...
                                                    <div class="col-sm-3 sm-select">
                                                        ...
                                                        <select name="p_from_min" id="p_from_min" class="">
                                                            <?php
                                                            $date_from  = $pricing->date_from;
                                                            $from_min    = date('i', strtotime($date_from));
                                                            for($pm = 0; $pm < 60; $pm++)
                                                            {
                                                                if($from_min == sprintf("%'.02d", $pm))
                                                                    $selected = 'selected="selected"';
                                                                else
                                                                    $selected = '';

                                                                echo '<option '.$selected.' value="'.sprintf("%'.02d", $pm).'">'.sprintf("%'.02d", $pm).'</option>';
                                                            }
                                                ...
                                                <div class="row" style="padding-left:15px;">
                                                    <div class="col-sm-3 sm-select">
                                                        <select name="p_to_day" id="p_to_day" class="">
                                                            <?php
                                                            $pricing_to_year = date('Y', strtotime($pricing->date_to));
                                                            $pricing_to_month = date('m', strtotime($pricing->date_to));
                                                            $pricing_to_day = date('d', strtotime($pricing->date_to));

                                                             $days = cal_days_in_month(CAL_GREGORIAN,  $pricing_to_month, $pricing_to_year);
                                                            $options = '';
                                                            $today = date('d');
                                                    ...
                                                    <div class="col-sm-3 sm-year">
                                                        <select name="p_to_year" id="p_to_year" class="" onchange="getYearMonths(this.value, 'p_to_month')">
                                                            ...
                                                            $from_y    = date('Y', strtotime($date_to));
                                                            for($y = 2016; $y <= 2060; $y++)
                                                            {
                                                                if($from_y == sprintf("%'.02d", $y))
                                                                    $selected = 'selected="selected"';
                                                    ...
                                                    <div class="col-sm-3 sm-select">
                                                        <select name="p_to_hour" id="p_to_hour" class="">
                                                            <?php
                                                            $date_to  = $pricing->date_to;
                                                            $from_hr    = date('H', strtotime($date_to));
                                                            for($ph = 0; $ph < 24; $ph++)
                                                            {
                                                                if($from_hr == sprintf("%'.02d", $ph))
                                                                    $selected = 'selected="selected"';
                                                    ...
                                                    <div class="col-sm-3 sm-select">
                                                        ...
                                                        <select name="p_to_min" id="p_to_min" class="">
                                                            <?php
                                                            $date_to  = $pricing->date_to;
                                                            $from_min    = date('i', strtotime($date_to));
                                                            for($pm = 0; $pm < 60; $pm++)
                                                            {
                                                                if($from_min == sprintf("%'.02d", $pm))
                                                                    $selected = 'selected="selected"';
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-control input-inline input-sm " name="pricing_method" id="pricing_method">
                                                    <option value="1" @if($pricing->discount_type == 'percentage') selected="selected" @endif> Percentage</option>
                                                    <option value="2" @if($pricing->discount_type == 'fixed') selected="selected" @endif>Fixed Amount</option>
                                                    <option value="3" @if($pricing->discount_type == 'freeshipping') selected="selected" @endif>Free Shipping</option>
                                                    <option value="4" @if($pricing->discount_type == 'freeproduct') selected="selected" @endif>Free Product</option>
                                                </select>
                                                <span class="help-block">  </span>
                                            </div>
                                        </div>

                                        <div class="percentage_div method_div @if($pricing->discount_type == 'percentage') active @endif" id="percentage_div" >
                                            <div class="form-group">
                                                <label class="col-md-4 control-label">Discount</label>
                                                <div class="col-md-8">
                                                    <input type="text" name="p_discount" id="p_discount" placeholder="% value" value="{{ $pricing->discount_value }}" class="form-control input-inline input-sm " >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="mt-radio-inline">
                                                        <label class="mt-radio">
                                                            <input type="radio" name="p_applies_on" @if($pricing->applies_on  == 'all') checked="checked" @endif  class="p_applies_on" value="all" checked="checked"> All
                                                            <span></span>
                                                        </label>
                                                        <label class="mt-radio">
                                                            <input type="radio" name="p_applies_on" @if($pricing->applies_on  == 'category') checked="checked" @endif class="p_applies_on"  value="category" > Category
                                                            <span class=""></span>
                                                        </label>
                                                        <label class="mt-radio">
                                                            <input type="radio" name="p_applies_on"  @if($pricing->applies_on  == 'products') checked="checked" @endif class="p_applies_on" value="products"> Products
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="p_percentage_category_div p_applies_on_div @if($pricing->applies_on  == 'category') active @endif ">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select id="p_applies_category" name="p_applies_category[]"  data-tags="true" data-placeholder="Select Category" data-allow-clear="true" class="form-control input-inline input-sm  select2" >
                                                            ...
                                                            @foreach($categories as $category)
                                                                @if(in_array($category['category_id'], $pricing_ids))
                                            ...
                                            <div class="p_percentage_products_div p_applies_on_div  @if($pricing->applies_on  == 'products') active @endif ">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select id="p_applies_on_products" name="p_applies_on_products[]" data-tags="true" data-placeholder="Select Products" data-allow-clear="true" multiple  class="form-control input-inline input-sm  select2" >
                                                            @foreach($products as $product)
                                                                @if(in_array($product->id, $pricing_ids))
                                                ...
                                                <div class="col-md-8">
                                                    <select name="p_order_value[]" id="p_order_value" class="form-control input-inline input-sm  select2" multiple data-tags="true" data-placeholder="Select order values">
                                                        @foreach($order_values as $order_value)
                                                            ...
                                                            <option  @if(in_array($order_value->id, $pricing_categories)) selected="selected" @endif value="{{ $order_value->id }}"> {{ money($order_value->min_order_value) }} - {{ $max_order }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input class="form-control input-inline input-sm " name="p_number_of_products" name="p_number_of_products"  value="{{ $pricing->min_products_order }}"  >
                                                    <span class="help-block">  </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="mt-radio-inline">
                                                        <label class="mt-radio">
                                                            <input type="radio" name="p_visible_in" id="p_visible_in_catalog" value="catalog" @if($pricing->visible_in  == 'catalog') checked="checked" @endif> Catalog
                                                            <span></span>
                                                        </label>
                                                        <label class="mt-radio">
                                                            <input type="radio" name="p_visible_in" id="p_visible_in_cart" value="cart" @if($pricing->visible_in  == 'cart') checked="checked" @endif > Cart
                                                            <span></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="mt-radio-inline">
                                                        <label class="mt-radio">
                                                            <input type="radio" name="p_coupon_based"   value="no"  @if($pricing->coupon_id == 0) checked="checked" @endif> No
                                                            <span></span>
                                                        </label>
                                                        <label class="mt-radio">
                                                            <input type="radio" name="p_coupon_based"   value="yes" @if($pricing->coupon_id  != 0) checked="checked" @endif> Yes
                                                            <span></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group" id="p_coupon_div" @if($pricing->coupon_id != 0) style="display: block; " @endif>
                                                ...
                                                <div class="col-md-8">
                                                    <select id="p_coupon_id" name="p_coupon_id" data-tags="true" data-placeholder="Select Coupon" data-allow-clear="true" class="form-control input-inline input-sm  select2" >
                                                        ...
                                                        @foreach($coupons as $coupon)
                                                            @if($pricing->coupon_id == $coupon->id)
                                                                <option value="{{$coupon->id}}" selected="selected">{{ $coupon->code }}</option>
                                                            @else
                                        ...
                                        <div class="fixed_div method_div @if($pricing->discount_type == 'fixed') active @endif" id="fixed_div" >
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">Discount</label>
                                                    <div class="col-md-8">
                                                        <input type="text" name="f_discount" id="f_discount" placeholder="discount value" value="{{ $pricing->discount_value }}" class="form-control input-inline input-sm " >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="mt-radio-inline">
                                                            <label class="mt-radio">
                                                                <input type="radio" name="f_applies_on" class="f_applies_on" value="all" @if($pricing->applies_on == 'all') checked="checked" @endif > All
                                                                <span></span>
                                                            </label>
                                                            <label class="mt-radio">
                                                                <input type="radio" name="f_applies_on"   class="f_applies_on"  value="category" @if($pricing->applies_on == 'category') checked="checked" @endif > Category
                                                                <span></span>
                                                            </label>
                                                            <label class="mt-radio">
                                                                <input type="radio" name="f_applies_on"  class="f_applies_on" value="products" @if($pricing->applies_on == 'products') checked="checked" @endif> Products
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="f_percentage_all_div f_applies_on_div @if($pricing->applies_on == 'all') active @endif" >

                                                </div>

                                                <div class="f_percentage_category_div f_applies_on_div  @if($pricing->applies_on == 'category') active @endif">
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label">Category</label>
                                                        <div class="col-md-8">
                                                ...
                                                <div class="f_percentage_products_div f_applies_on_div  @if($pricing->applies_on == 'products') active @endif ">
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label">Products</label>
                                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                    <label class="col-md-4 control-label">Min Number of Products</label>
                                                    <div class="col-md-8">
                                                        <input class="form-control input-inline input-sm " name="f_number_of_products" value="{{ $pricing->min_products_order }}"  >
                                                        <span class="help-block">  </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="mt-radio-inline">
                                                            <label class="mt-radio">
                                                                <input type="radio" name="f_visible_in" id="f_visible_in_catalog" value="catalog" @if($pricing->visible_in  == 'catalog') checked="checked" @endif> Catalog
                                                                <span></span>
                                                            </label>
                                                            <label class="mt-radio">
                                                                <input type="radio" name="f_visible_in" id="f_visible_in_cart" value="cart" @if($pricing->visible_in  == 'cart') checked="checked" @endif> Cart
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="mt-radio-inline">
                                                            <label class="mt-radio">
                                                                <input type="radio" name="f_coupon_based"   value="no"  @if($pricing->coupon_id == 0) checked="checked" @endif> No
                                                                <span></span>
                                                            </label>
                                                            <label class="mt-radio">
                                                                <input type="radio" name="f_coupon_based"   value="yes" @if($pricing->coupon_id != 0) checked="checked" @endif> Yes
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group" id="f_coupon_div" @if($pricing->coupon_id != 0) style="display:block" @endif>
                                                    <label class="col-md-4 control-label">Coupon</label>
                                                    <div class="col-md-8">
                                        ...
                                        <div class="free_shipping_div method_div @if($pricing->discount_type == 'freeshipping') active @endif" id="free_shipping_div">

                                            <div class="form-group">
                                                <label class="col-md-4 control-label">Min Order value</label>
                                                <div class="col-md-8">
                                                    <input class="form-control input-inline input-sm " name="fs_min_order_value" id="fs_min_order_value" value="{{ $pricing->min_order_value }}"  >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="mt-radio-inline">
                                                        <label class="mt-radio">
                                                            <input type="radio" name="fs_visible_on_success" id="fs_visible_on_success_no" class="fs_visible_on_success" value="no" @if($pricing->visible_with_success == 'no' ) checked="checked" @endif> No
                                                            <span></span>
                                                        </label>
                                                        <label class="mt-radio">
                                                            <input type="radio" name="fs_visible_on_success" id="fs_visible_on_success_yes" class="fs_visible_on_success" value="yes" @if($pricing->visible_with_success == 'yes' ) checked="checked" @endif > Yes
                                                            <span></span>
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="free_product_div method_div @if($pricing->discount_type == 'freeproduct') active @endif" id="free_product_div">
                                            <div class="form-group">
                                                <label class="col-md-4 control-label">Min Number of Products</label>
                                                <div class="col-md-8">
                                                    <input class="form-control input-inline input-sm " name="fp_number_of_products" id="fp_number_of_products"  value="{{ $pricing->min_products_order }}"  >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="mt-radio-inline">
                                                            <label class="mt-radio">
                                                                <input type="radio" name="fp_applies_on"  class="fp_applies_on"  value="category" @if($pricing->applies_on == 'category') checked="checked" @endif > Category
                                                                <span></span>
                                                            </label>
                                                            <label class="mt-radio">
                                                                <input type="radio" name="fp_applies_on"   class="fp_applies_on" value="products" @if($pricing->applies_on == 'products') checked="checked" @endif> Products
                                                                <span ></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="fp_percentage_category_div fp_applies_on_div @if($pricing->applies_on == 'category') active @endif">
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label">Category</label>
                                                        <div class="col-md-8">
                                                ...
                                                <div class="fp_percentage_products_div fp_applies_on_div @if($pricing->applies_on == 'products') active @endif">
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label">Products</label>
                                                        <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="mt-radio-inline">
                                                            <label class="mt-radio">
                                                                <input type="radio" name="fp_as_discount" class="fp_as_discount"  value="cheapest" @if($pricing->coupon_id == 0) checked="checked" @endif > Cheapest Product
                                                                <span></span>
                                                            </label>
                                                            <label class="mt-radio">
                                                                <input type="radio" name="fp_as_discount"  class="fp_as_discount" value="product" @if($pricing->coupon_id != 0) checked="checked" @endif> Specific Product
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            <div class="fp_specific_product" @if($pricing->coupon_id != 0) style="display: block;" @endif >
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select name="fp_use_as_discount" id="fp_use_as_discount" data-tags="true" data-placeholder="Select Product" data-allow-clear="true" class="form-control input-inline input-sm  select2"  >
                                                            <option></option>
                                                            @foreach($products as $product)
                                                                @if($product->id == $pricing->use_as_discount_product)
                                                                    <option selected value="{{$product->id}}">{{ $product->name }}</option>
                                                                @else
                                                                    <option value="{{$product->id}}">{{ $product->name }}</option>
                                                                @endif
                                            ...
                                            <div class="row">
                                                <div class="col-md-offset-4 col-md-7">
                                                    <button type="button" id="submitbtn" class="btn green"> Update Action</button>
                                                </div>
                                            </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        function submitAction(action_type)
        {
            $('#action_form').submit();
            /*
