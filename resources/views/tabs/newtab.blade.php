...
<form id="post-form" action="{{action('TabsController@store')}}"  method="post">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="portlet box default">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>Page description
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <textarea class="form-control" name="tab-editor" id="tab-editor"></textarea>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="portlet box default">
                ...
                <div class="portlet-body">
                    <button name="save" id="save" type="submit"  class="btn btn-primary pull-left btn-sm ">Save Tab</button>
            ...
            <div class="portlet box default">
                ...
                <div class="portlet-body">
                      <select name="parent_id" class="input form-control parent_product">
