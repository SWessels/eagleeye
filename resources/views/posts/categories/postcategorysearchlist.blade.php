...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            {{--<span>Categories {{ dd($categories) }}</span>--}}
        </li>
    </ul>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject font-blue-sharp bold uppercase">Nieuwe bericht categorie toevoegen</span>
                    </div>
            ...
            <div class="portlet ">
                ...
                <div class="portlet-body">
                    <div class="table-container">
                        ...
                        <form role="form" name="delform" id="delform" action=" {{action('PostCategoryController@delete')}} " method="post">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select name="remove"  id="remove" class="form-control">
                                    ...
                                    <option value="rm">Verwijder</option>

                                </select>
                            </div> <button type="submit" id="apply" class="btn blue">Toepassen</button>
                            <table class="table table-striped table-bordered table-hover" id="datatable_products">
                                ...
                                @if(count($data) > 0)
                                    ...
                                    @foreach($data as $cat)
                               <tr>
                                    <td><input name="del[]" id="del['{{ $cat['id']}}']" value="{{ $cat['id'] }}" type="checkbox" class="checkboxes">
                      {{--  <input type="text" name="parent_id"  value="{{ $category['parent_id'] }}"  />--}}
                              </td>

                               <td> <a href="  {{ route('PostCategories.edit',$cat['id']) }}">
                                    {{ $cat['name'] }} </a></td>
